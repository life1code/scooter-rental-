...
function AdminDashboardContent() {
    ...
    const filteredBookings = bookings.filter(booking => {
        const matchesSearch = searchTerm === "" ||
            ...
            booking.riderName.toLowerCase().includes(searchTerm.toLowerCase());

        const matchesShop = shopFilter === null ||
            (booking.scooter?.host?.institutionName || "Ride Admin") === shopFilter;
    ...
    // const userRole = (session?.user as any)?.role; // Already defined above
    // const approvalStatus = (session?.user as any)?.approvalStatus; // Already defined above
    // const isSuperAdmin = userRole === "superadmin"; // Already defined above
