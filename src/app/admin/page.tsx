...
>>>>>>> 67b28cd (Restore Admin Dashboard features: Fleet link, Grid layout, Auth logic)
    ...
    useEffect(() => {
        // All fetches are now silent by default to suppress noisy console errors during server restarts
        fetchBookings(true);
        fetchScooters(true);
    ...
    // Loading state for auth verification - Moved after hooks to comply with Rules of Hooks
    if (status === "loading") {
        return (
...
<<<<<<< HEAD
                    <div className="flex flex-wrap gap-4">
                        <Link
                            href="/track"
                            className="btn-secondary !bg-blue-500/10 !text-blue-500 !border-blue-500/20 flex items-center justify-center gap-2 !py-3 px-6 rounded-xl hover:!bg-blue-500/20 transition-all font-bold text-sm"
                        >
                        ...
                        <Link
                            ...
                            className="btn-secondary !bg-purple-500/10 !text-purple-500 !border-purple-500/20 flex items-center justify-center gap-2 !py-3 px-6 rounded-xl hover:!bg-purple-500/20 transition-all font-bold text-sm"
                        >
...
>>>>>>> 67b28cd (Restore Admin Dashboard features: Fleet link, Grid layout, Auth logic)
                        ...
                        {isSuperAdmin ? (
                            <button
                                ...
                                className={cn(
                                    "btn-secondary flex items-center justify-center gap-2 !py-3 px-6 rounded-xl transition-all font-bold text-sm",
                                    view === 'hosts'
                                        ? "!bg-[var(--primary)] !text-black border-none shadow-[0_0_20px_rgba(45,212,191,0.3)]"
                                        : "!bg-white/5 !text-white/80 !border-white/10 hover:!bg-white/10"
                                )}
                            >
                                <Settings className="w-4 h-4" /> {view === 'hosts' ? "Back to Overview" : "Management"}
                            </button>
                        ) : (
                            <Link
                                href="/admin/fleet"
                                className="btn-secondary !bg-white/5 !text-white/80 !border-white/10 flex items-center justify-center gap-2 !py-3 px-6 rounded-xl hover:!bg-white/10 transition-all font-bold text-sm"
                            >
                                <Settings className="w-4 h-4" /> Management
                            </Link>
                        )}

                        {(isSuperAdmin || userRole === 'admin' || (userRole === 'host' && approvalStatus === 'approved')) && (
                            <Link
                                href="/admin/scooters/new"
                                className="btn-primary flex items-center justify-center gap-2 !py-3 px-6 rounded-xl !bg-[var(--primary)] !text-black shadow-[0_0_30px_rgba(45,212,191,0.4)] hover:shadow-[0_0_40px_rgba(45,212,191,0.6)] transition-all font-bold text-sm"
                            >
                                <Plus className="w-4 h-4" /> Add New Scooter
                            </Link>
                        )}
